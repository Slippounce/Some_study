...
import ru.nsu.fit.g16205.shmidt.task_filter.FileUtils;
...
public class MainFrame extends JFrame {
    ...
    public JToggleButton createToolBarToggledButton(JMenuItem item){
...
//     * @see MainFrame.getMenuItem
    ...
    public JToggleButton createToolBarToggledButton(String menuPath)
    {
        JMenuItem item = (JMenuItem)getMenuElement(menuPath);
        if(item == null)
            throw new InvalidParameterException("Menu path not found: "+menuPath);
        return createToolBarToggledButton(item);
    }
    ...
    public void addToolBarToggledButton(String menuPath){
        toolBar.add(createToolBarToggledButton(menuPath));
    }
