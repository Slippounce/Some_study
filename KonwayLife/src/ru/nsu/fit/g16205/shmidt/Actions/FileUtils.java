...
import ru.nsu.fit.g16205.shmidt.konwaygraphic.MainFrame;
...
//     */
    public static File getSaveFileName(JFrame parent, String extension, String description)
    {
        ...
        File directory = new File(getDataDirectory().getAbsolutePath()+"\\..\\..\\saved");

        fileChooser.setCurrentDirectory(directory/*getDataDirectory()*/);
...
//     */
    public static File getOpenFileName(JFrame parent, String extension, String description)
    {
        ...
        FileFilter filter = new ExtensionFileFilter(extension, description);
        fileChooser.addChoosableFileFilter(filter);
        File startDirectory = new File(getDataDirectory().getAbsolutePath()+"\\..\\..\\game field templates");
        fileChooser.setCurrentDirectory(startDirectory/*getDataDirectory()*/);
